...
status: "scheduled"
subtitle: "A baseline is not a fixed number or a permanent verdict on your body. It is simply what counts as usual for you right now, so you and a specialist can both recognize when something has genuinely changed. Setting one does not take a perfect month of notes. It takes a short, honest window of tracking and a clear way to compare it later."
description: "Learn how to set a symptom baseline before a specialist visit, including what to track, how long to track it, and how to notice when your baseline has shifted."
excerpt: "Learn how to set a symptom baseline before a specialist visit, including what to track, how long to track it, and how to notice when your baseline has shifted."
...
seoTitle: "How to Set a Symptom Baseline | Zebra"
metaDescription: "Learn how to set a symptom baseline before a specialist visit: what to track, how long, and how to tell a real shift from a bad week."
ogTitle: "How to Set a Symptom Baseline Before a Specialist Visit"
ogDescription: "A short, honest tracking window is enough to build a baseline a specialist can compare against — here is how to build one without overdoing it."
heroImage: "/screenshots/insight-history.png"
heroImageAlt: "Symptom history view showing a stable pattern of daily check-ins used to establish a personal baseline."
ctaLabel: "Download Zebra"
ctaHref: "https://apps.apple.com/us/app/zebra-symptom-tracker/id6768839130"
ctaNote: "Download Zebra to track your usual symptoms and function, so a real shift is easy to see and easy to show a specialist."
featured: false
categories:
...
secondaryKeywords:
  ...
  - "baseline shift chronic illness"
  - "tracking usual symptoms before doctor visit"
  - "how to know if symptoms are getting worse"
schemaTypes:
  - "Article"
  - "HowTo"
  - "FAQPage"
faq:
  - question: "What is a symptom baseline?"
    answer: "A symptom baseline is what counts as usual for you right now: your typical symptoms, severity, and functional capacity on an ordinary day. It is a comparison point, not a diagnosis or a fixed score."
  - question: "How long does it take to set a baseline?"
    answer: "A short, honest window is usually enough. One to two weeks of consistent tracking, including at least one bad day, gives a specialist something real to compare against."
  - question: "Can a baseline change?"
    answer: "Yes. Baselines shift over time, for better or worse. Noticing a shift is not a failure of your old baseline. It is useful information about where things stand now."
  - question: "How do I know if I am having a bad week or a real baseline shift?"
    answer: "A single bad day or a short flare usually returns to your prior usual. A shift is more convincing when a new level of symptoms or function holds for more than a couple of weeks, not just a few days."
  - question: "Do I need to track every day to build a baseline?"
    answer: "No. Missing a day does not erase your baseline. What matters is a reasonably consistent pattern over the tracking window, including both ordinary and difficult days."
  - question: "What if I already suspect my baseline has changed?"
    answer: "Track the current pattern for a short window anyway. A specialist responds better to a comparison between a documented old baseline and a documented current one than to a description from memory alone."
---
...
Zebra's [doctor report](/doctor-report/) is built to hold this same comparison, so you are not rebuilding it from memory the night before an appointment.
